    ...
    def __init__(self, scale_factor, in_size, out_size, num_channels=1, d=56, s=12, m=4):
        ...
        for i in range(m):
            self.mid_part.extend([nn.ReplicationPad2d(1),
                                  ...
                                  nn.PReLU()])
            # self.mid_part.extend([nn.Conv2d(s, s, kernel_size=3, padding=1, padding_mode='replicate'),
            #                       nn.PReLU(s)])
